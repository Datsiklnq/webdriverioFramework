...
// that question mark during  runtime if we set debug mode to true then it gone executoe 99999 else 
// if we add no debug mode into runtime it gona execute 10 sec
